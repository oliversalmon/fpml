 ...
 *       &lt;choice>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/legal}Party.model"/>
 *         &lt;sequence>
 *           &lt;element name="groupType" type="{http://www.fpml.org/FpML-5/legal}PartyGroupType"/>
 *           &lt;element name="partyReference" type="{http://www.fpml.org/FpML-5/legal}PartyReference" maxOccurs="unbounded" minOccurs="2"/>
 *         &lt;/sequence>
 *       &lt;/choice>
...
@XmlType(name = "Party", namespace = "http://www.fpml.org/FpML-5/legal", propOrder = {
    "partyId",
    "partyName",
    "classification",
    "creditRating",
