 ...
 *           &lt;element name="documentId" type="{http://www.fpml.org/FpML-5/legal}LegalDocumentId"/>
 *           &lt;element name="documentVersion" type="{http://www.fpml.org/FpML-5/legal}Token" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/sequence>
...
@XmlType(name = "PartyDocumentIdentifier", namespace = "http://www.fpml.org/FpML-5/legal", propOrder = {
    "partyReference",
...
public class PartyDocumentIdentifier {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "documentId", namespace = "http://www.fpml.org/FpML-5/legal", type = JAXBElement.class),
        @XmlElementRef(name = "documentVersion", namespace = "http://www.fpml.org/FpML-5/legal", type = JAXBElement.class)
    })
    @Generated(value = "com.sun.tools.internal.xjc.Driver", date = "2018-10-30T08:17:37+00:00", comments = "JAXB RI v2.2.8-b130911.1802")
