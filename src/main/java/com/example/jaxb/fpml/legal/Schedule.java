 ...
 *         &lt;element name="step" type="{http://www.fpml.org/FpML-5/legal}Step" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "Schedule", namespace = "http://www.fpml.org/FpML-5/legal", propOrder = {
    "initialValue",
    "step"
})
@XmlSeeAlso({
