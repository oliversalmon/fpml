 ...
 *         &lt;choice minOccurs="0">
 *           &lt;element name="spread" type="{http://www.fpml.org/FpML-5/recordkeeping}CommoditySpread"/>
 *           &lt;element name="spreadSchedule" type="{http://www.fpml.org/FpML-5/recordkeeping}CommoditySpreadSchedule" maxOccurs="unbounded"/>
...
@XmlType(name = "FloatingLegCalculation", namespace = "http://www.fpml.org/FpML-5/recordkeeping", propOrder = {
    "pricingDates",
    "averagingMethod",
    "conversionFactor",
    "rounding",
