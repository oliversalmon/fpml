 ...
 *       &lt;sequence>
 *         &lt;element name="condition" type="{http://www.fpml.org/FpML-5/recordkeeping}FxRegionUpperBoundDirectionEnum"/>
...
@XmlType(name = "FxAccrualRegionUpperBound", namespace = "http://www.fpml.org/FpML-5/recordkeeping", propOrder = {
    "condition",
    "level",
    "quoteBasis",
    "strikeReference",
