 ...
 *         &lt;element name="fxRate" type="{http://www.fpml.org/FpML-5/recordkeeping}FxRate" maxOccurs="unbounded"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FxConversion", namespace = "http://www.fpml.org/FpML-5/recordkeeping", propOrder = {
    "amountRelativeTo",
    "fxRate"
})
