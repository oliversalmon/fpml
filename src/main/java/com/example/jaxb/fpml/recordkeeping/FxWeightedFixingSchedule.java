 ...
 *           &lt;element name="fixing" type="{http://www.fpml.org/FpML-5/recordkeeping}FxFixingObservation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *         &lt;sequence>
 ...
 *             &lt;element name="fixing" type="{http://www.fpml.org/FpML-5/recordkeeping}FxFixingObservation" maxOccurs="unbounded"/>
 *           &lt;/choice>
 *         &lt;/sequence>
 *       &lt;/choice>
 *     &lt;/restriction>
...
@XmlType(name = "FxWeightedFixingSchedule", namespace = "http://www.fpml.org/FpML-5/recordkeeping", propOrder = {
    "content"
})
public class FxWeightedFixingSchedule {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "fixing", namespace = "http://www.fpml.org/FpML-5/recordkeeping", type = JAXBElement.class, required = false),
