 ...
 *               &lt;element name="versionedTradeId" type="{http://www.fpml.org/FpML-5/recordkeeping}VersionedTradeId"/>
 *             &lt;/choice>
 *           &lt;/sequence>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "TradeIdentifier", namespace = "http://www.fpml.org/FpML-5/recordkeeping", propOrder = {
    "issuer",
    "tradeId",
    "partyReference",
    "accountReference",
...
public class TradeIdentifier {
    ...
    @XmlElements({
        @XmlElement(name = "tradeId", namespace = "http://www.fpml.org/FpML-5/recordkeeping", type = TradeId.class),
        @XmlElement(name = "versionedTradeId", namespace = "http://www.fpml.org/FpML-5/recordkeeping", type = VersionedTradeId.class)
    })
